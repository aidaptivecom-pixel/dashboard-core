      ...
      >
        ...
        <div className="text-center mb-8">
          <motion.div
            ...
            className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-primary to-purple mb-4"
          >
            <Sparkles className="h-8 w-8 text-white" />
          </motion.div>
          <h1 className="text-2xl font-bold">FocusFlow</h1>
          <p className="text-muted-foreground mt-2">Tu sistema operativo personal</p>
        </div>
        ...
        <div className="rounded-2xl border border-border bg-background p-6 shadow-lg">
          {emailSent ? (
            ...
            >
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-mint/10 mb-4">
            ...
            <>
              <h2 className="text-lg font-semibold mb-6 text-center">Iniciá sesión</h2>

              {/* Google Login */}
              <button
                onClick={handleGoogleLogin}
                disabled={isLoading}
                className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border border-border hover:bg-accent transition-colors disabled:opacity-50"
              >
