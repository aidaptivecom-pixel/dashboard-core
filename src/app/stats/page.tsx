...
export default function StatsPage() {
    ...
    const lastWeekTasks = 28; // Mock data
            ...
            <div className="max-w-5xl mx-auto">
                ...
                >
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            Mirá tu productividad y seguí tu progreso
                        </p>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="px-4 py-2 rounded-xl bg-muted text-sm font-medium min-w-[140px] text-center">
                            {getWeekLabel()}
                        </span>
                        <button
                            ...
                            className={cn(
                                "p-2 rounded-xl hover:bg-accent",
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-8">
                    ...
                    >
                        ...
                        <p className="text-3xl font-bold">{totalFocus}h</p>
                    ...
                    >
                        <Flame className="h-5 w-5 text-coral mb-2" />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                    ...
                    >
                        <h3 className="font-semibold mb-4">Actividad diaria</h3>
                        <div className="h-64">
                                    ...
                                    <div key={goal.id}>
                                        ...
                                        <div className="h-2 bg-muted rounded-full overflow-hidden">
                                            <motion.div
                                                className={cn(
                                                    "h-full rounded-full",
                                                    progress >= 100 ? "bg-mint" : "bg-primary"
                                                )}
                                                initial={{ width: 0 }}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <motion.div
                        ...
                        className="p-6 rounded-2xl border border-border bg-background"
                    >
                        <h3 className="font-semibold mb-4">Tiempo por espacio</h3>
                        <div className="h-48">
                            <ResponsiveContainer width="100%" height="100%">
                        ...
                        <div className="mt-4 grid grid-cols-2 gap-2">
                            {spaceData.map((space) => (
                                <div key={space.name} className="flex items-center gap-2 text-sm">
