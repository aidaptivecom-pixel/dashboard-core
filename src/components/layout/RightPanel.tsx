...
export function RightPanel() {
    return (
        <aside className="hidden xl:flex xl:w-80 2xl:w-96 h-screen flex-col gap-4 p-4 border-l border-border bg-background/50 backdrop-blur-sm overflow-y-auto custom-scrollbar">
            <UpcomingEvents />
            <AIMiniChat />
            <QuickInsights />
